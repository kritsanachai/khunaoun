...
<div class="d-flex justify-content-evenly mt-3">
    <button class="btn btn-warning" id="deliveryOrder" data-id="<?php echo $idOrder; ?>">ยืนยันการจัดส่ง</button>
    <!-- <button class="btn btn-danger" id="cancelOrder" data-id="<?php echo $idOrder; ?>">ยกเลิกออเดอร์</button> -->
</div>
